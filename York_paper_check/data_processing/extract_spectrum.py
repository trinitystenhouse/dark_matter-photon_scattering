...
def main():
    ...
    PROCESSED_DIR = os.path.join(REPO_DIR, "fermi_data", "york", "processed")
    os.makedirs(PROCESSED_DIR, exist_ok=True)

    fits_file = os.path.join(PROCESSED_DIR, "GC_filtered_merged.fits")
    ...
    save_spectrum_data(
        ...
        flux_err,
        counts,
        output_file=os.path.join(PROCESSED_DIR, "spectrum_data.txt"),
    )
    ...
    plot_spectrum(
        ...
        flux,
        flux_err,
        output_file=os.path.join(PROCESSED_DIR, "spectrum.png"),
    )
