...
# Only valid for low masses where we stay in the perturbative regime.
...
def plot_spectrum(
    ...
    y_eff = get_y_eff_from_mchi(mchi)
    ...
    ax_top.plot(
        E_fit, F_dm_fit*1e6,
        label=f"Flux with Scattering for y_eff = {y_eff:.1e}"
    )
